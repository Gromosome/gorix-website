...
Add `localhost` and every production origin under **Authorized domains**. For GitHub Pages, that usually means:

- `<owner>.github.io`
- `<owner>.github.io/<repo>` uses the same authorized domain, `<owner>.github.io`
